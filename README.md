...
- 📊 **청약 경쟁률** — 주택형·순위·거주지별 경쟁률 표 + 막대 시각화 (당첨자 발표된 건)
- 🗺 **카카오 지도** — 상세 단지 위치 + **지도 뷰로 여러 단지 마커** 한눈에 (키 있을 때) / 검색 링크(폴백)
- 🔔 **관심단지 청약 임박 알림** — 접수중·임박 건 상단 배너 + 브라우저 로컬 알림
- ⭐ **관심단지 즐겨찾기** (브라우저 localStorage 저장)
- 🌙 **다크모드** (라이트/다크 토글, 시스템 설정 연동)
