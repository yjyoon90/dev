...
서울·경기 지역의 **아파트·오피스텔 청약 일정과 상세정보**를 한눈에 볼 수 있는 반응형 웹앱입니다.
...
- 🔎 **지역(서울/경기) → 시/군/구**, 유형(APT/무순위/오피스텔), 상태(접수중/예정/마감) 필터 + 단지명 검색
...
4. 서버를 재시작하면 실제 서울·경기 청약 데이터가 표시됩니다. (샘플 배너 사라짐)
